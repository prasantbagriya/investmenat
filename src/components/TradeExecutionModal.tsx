      ...
      {isOpen && (
        <div className="fixed inset-0 z-100 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          ...
          <motion.div 
            ...
            className="relative w-full max-w-2xl bg-white rounded-xl shadow-xl border border-slate-200 overflow-hidden max-h-[95vh] overflow-y-auto"
          >
            {/* Header */}
            ...
            <div className="p-5 space-y-5">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="text-xs font-bold text-slate-500 capitalize block mb-1">Product</label>
                  <select 
                    value={productType} 
                ...
                <div>
                  <label className="text-xs font-bold text-slate-500 capitalize block mb-1">Type</label>
                  <select 
                    value={orderType} 
              ...
              <div className={`grid ${isGtt ? 'grid-cols-3' : 'grid-cols-2'} gap-3`}>
                <div>
                  <label className="text-xs font-bold text-slate-500 capitalize block mb-1">Quantity</label>
                  <input 
                    type="number" 
                    min="1"
                    value={quantity}
                ...
                {isGtt && (
                  <div>
                    <label className="text-xs font-bold text-slate-500 capitalize block mb-1">Trigger Price</label>
                    <input 
                      type="number" 
                      value={triggerPrice}
                ...
                <div>
                  <label className="text-xs font-bold text-slate-500 capitalize block mb-1">{isGtt ? 'Limit Price' : 'Price'}</label>
                  <input 
                    type="number" 
                    value={price}
              ...
              {/* Broker Selection */}
              <div>
                <label className="text-xs font-bold text-slate-500 capitalize block mb-2">Route Order Via</label>
