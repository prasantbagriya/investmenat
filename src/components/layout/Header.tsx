...
import { 
  ...
  Briefcase, Settings, CalendarRange, Landmark, Percent, FileSpreadsheet, Download, ShieldCheck, LogOut, Menu, Wallet
} from 'lucide-react';
          ...
          <div className="flex items-center gap-2 select-none shrink-0">
            ...
            <div className="flex bg-slate-100/80 border border-slate-200/60 rounded-xl p-0.5 gap-0.5 ml-1 sm:ml-2" id="workspace-pill-switcher">
              <Link
                ...
                to="/dashboard"
                className={`flex items-center gap-1 px-1.5 py-1 rounded-lg text-xs sm:text-xs font-semibold transition-all cursor-pointer ${
              ...
              >
                <Wallet size={11} className={currentWorkspace === 'crypto' ? 'text-indigo-400' : 'text-slate-500'} /> 
                <span className="hidden xs:inline">Crypto</span>
              </Link>
              <Link
                id="workspace-quicko-btn"
                onClick={() => {
              ...
              >
                <ShieldCheck size={11} className={currentWorkspace === 'quicko' ? 'text-blue-400' : 'text-slate-500'} /> 
                <span className="hidden xs:inline">Quicko</span>
              </Link>
            </div>
          </div>
          ...
          <div className="flex items-center gap-1 shrink-0">
            {deferredPrompt && (
              <button
                ...
                className="flex items-center gap-1 bg-emerald-500 hover:bg-emerald-600 text-white p-1.5 px-2 rounded-lg font-bold text-xs transition-all cursor-pointer shadow-sm animate-pulse mr-1"
            ...
            <button
              ...
              className="hidden md:flex items-center gap-1 bg-white hover:bg-slate-50 text-slate-700 p-1.5 px-1 rounded-lg border border-slate-200 font-bold text-xs transition-all cursor-pointer shadow-xs"
