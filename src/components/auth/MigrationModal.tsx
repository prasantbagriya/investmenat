      ...
      {pendingMigrationData && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-2 bg-slate-900/60 backdrop-blur-xs">
          <motion.div
            ...
            className="bg-white rounded-xl border border-slate-200 shadow-2xl max-w-lg w-full overflow-hidden text-xs text-slate-800"
          >
            <div className="p-3 border-b border-slate-100 bg-amber-50/40">
              <div className="flex items-start gap-1">
                <div className="p-1 bg-amber-500 text-white rounded-lg shrink-0 shadow-md">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-700 font-semibold capitalize mt-0.5 ">
            ...
            <div className="p-3 space-y-2">
              ...
              <div className="grid grid-cols-2 gap-1 bg-slate-50 border border-slate-200/50 p-2 rounded-lg font-mono text-xs">
              ...
              {migrationProgress && (
                <div className="flex items-center gap-1 text-indigo-700 font-extrabold text-xs capitalize animate-pulse bg-indigo-50 border border-indigo-150 p-1 rounded-xl justify-center">
